...
| Teams Premium | AI-assisted productivity tool | Teams Premium is available as a cost option that adds a number of advanced features to the Teams experience:
i.	Premium meetings: use NHS branding and implement fine-grained security controls to protect sensitive discussions with enhanced encryption, watermarks, and security labels. Use live captions to automatically translate meetings into different languages.
